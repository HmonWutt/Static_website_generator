...
class TestHtmlNode(unittest.TestCase):
    ...
    def test_repr_without_children(self):
        self.assertEqual(f'HTMLNode(a, this is a link to google.com, None, href="https://google.com" target="_blank" )', repr(self.htmlnode1))

    def test_repr_with_children(self):
        self.assertEqual(f'HTMLNode(div, None, HTMLNode(a, this is a link to google.com, None, href="https://google.com" target="_blank" ), None)', repr(self.htmlnode2))
